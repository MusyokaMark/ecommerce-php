...
-- Create a table to store the subcategories
...
INSERT INTO subcategory (category_id, name) VALUES
    -- Fashion
    (10, 'Mobile & Feature Phone'),
    (10, 'Cellphone & Smart Phones Accessories'),
    (10, 'PDAs'),
    (10, 'Fitness Trackers, Smart Watches & Bands'),
    (10, 'IPad/Tablet/eBook'),
    (10, 'Otheers');

    INSERT INTO subcategory (category_id, name) VALUES
    -- Fashion
    (11, 'TVs, Receivers & Media Player'),
    (11, 'Laptops & Desktops'),
    (11, 'Home Theatres, Speakers & Audios'),
    (11, 'Radios, Stereos & Hi-Fi Systems'),
    (11, 'Video Games & Consoles'),
    (11, 'Photo, Video Cameras & Equipment'),
    (11, 'Headphones & Ear Pieces'),
    (11, 'Bags, Cases, Covers & Sleeves'),
    (11, 'Drives, Storage & Blank Media'),
    (11, 'Software'),
    (11, 'WiFi & Networking'),
    (11, 'Enterprise Networking & Servers'),
    (11, 'Computer Hardware & Accessories'),
    (11, 'Printers, Projectors, Scanners & Supplies'),
    (11, 'CDS, DVDs, VCRs & Blu-ray'),
    (11, 'Others');
...
ADD COLUMN `date_view` DATE NOT NULL,
ADD COLUMN `counter` INT(11) NOT NULL;

--
-- Dumping data for table `products`
--

INSERT INTO `products` (`category_id`, `name`, `description`, `slug`, `price`, `photo`, `date_view`, `counter`) VALUES
...
('admin@admin.com', '$2y$10$0SHFfoWzz8WZpdu9Qw//E.tWamILbiNCX7bqhy3od0gvK5.kSJ8N2', 1, 'Musyoka', 'Mark', '', '', 'thanos1.jpg', 1, '', '', '2023-05-01'),
('harry@den.com', '$2y$10$Oongyx.Rv0Y/vbHGOxywl.qf18bXFiZOcEaI4ZpRRLzFNGKAhObSC', 0, 'Harry', 'Den', 'Nairobi, Negros Occidental', '0792735719', 'male2.png', 1, 'k8FBpynQfqsv', 'wzPGkX5IODlTYHg', '2018-05-09'),
('christine@gmail.com', '$2y$10$ozW4c8r313YiBsf7HD7m6egZwpvoE983IHfZsPRxrO1hWXfPRpxHO', 0, 'Christine', 'becker', 'demo', '7542214500', 'female3.jpg', 1, '', '', '2023-07-09');
...
ALTER TABLE users
ADD COLUMN shop_name VARCHAR(100) NOT NULL;
